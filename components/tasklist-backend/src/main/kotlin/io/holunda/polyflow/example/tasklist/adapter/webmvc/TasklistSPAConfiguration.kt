package io.holunda.polyflow.example.tasklist.adapter.webmvc

import io.holunda.polyflow.example.tasklist.adapter.webmvc.Web.RESOURCE_LOCATION
import io.holunda.polyflow.example.tasklist.adapter.webmvc.Web.ROUTES
import io.holunda.polyflow.example.tasklist.adapter.webmvc.Web.STATIC_RESOURCES_LONG_CACHE
...
object Web {
  ...
  val STATIC_RESOURCES_SHORT_CACHE = arrayOf("$BASE_PATH/assets/*.png", "$BASE_PATH/assets/*.jpg", "$BASE_PATH/*.png", "$BASE_PATH/*.ico", "$BASE_PATH/*.json")
}
